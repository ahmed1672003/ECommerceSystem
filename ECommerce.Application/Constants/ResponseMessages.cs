...
{
    public const string SuccessMessage = "The request was completed successfully !";
    public const string NotFoundMessage = "The request was completed successfully but the data does not exist !";
